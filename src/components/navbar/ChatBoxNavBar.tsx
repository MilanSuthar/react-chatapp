...
import { FaCircleUser, FaEllipsisVertical, FaMagnifyingGlass } from 'react-icons/fa6'

const ChatBoxNavBar = () => {
  return (
    <div style={{width:'100%',height:60,backgroundColor:'lightgrey',display:'flex',alignItems:'center'}}>
    ...
    <div style={{display:'flex',flex:1,flexDirection:'column',paddingLeft:10}}>
    ...
    <div style={{height:50,width:50,borderRadius:'50%',display:'flex',justifyContent:'center',alignItems:'center'}}>
       <FaMagnifyingGlass style={{height:40,width:20}} color='whitesmoke'/>
    </div>
    <div style={{height:50,width:50,borderRadius:'50%',display:'flex',justifyContent:'center',alignItems:'center'}}>
